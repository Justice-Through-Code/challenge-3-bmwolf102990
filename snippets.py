...
def snippet_4():
    ...
    # Since I changed 'or not' to 'and not', in order for 'd' to
    # evaluate to True, both '(5 < 7)' AND '(8 < 20)' need to evaluate to True.
    # But since the NOT boolean operator comes before '(8 < 20)' it changes
    # its boolean evaluation from True to False. So since only '(5 < 7)'
    # now evaluates to True, variable 'd', as a whole, will evaluate to False.
